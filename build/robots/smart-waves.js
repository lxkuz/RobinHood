...
(function() {
  ...
  SmartWavesRobot = (function(superClass) {
    extend(SmartWavesRobot, superClass);

    function SmartWavesRobot() {
      this.nextBet = bind(this.nextBet, this);
      this.playAlgorithm = bind(this.playAlgorithm, this);
      return SmartWavesRobot.__super__.constructor.apply(this, arguments);
    }

    SmartWavesRobot.prototype.playAlgorithm = function(data) {
      ...
      if (this.betsData.length === 1) {
        return this.nextBet(data, this.betsData[0].type);
      }
    };

    SmartWavesRobot.prototype.nextBet = function(data, lastType) {
